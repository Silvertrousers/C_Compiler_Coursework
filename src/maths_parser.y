...
SELECTION_STATEMENT : T_IF T_LBRACKET EXPR T_RBRACKET STATEMENT {fprintf(stderr, "T_IF");}
                    | T_IF T_LBRACKET EXPR T_RBRACKET STATEMENT T_ELSE STATEMENT_LIST {fprintf(stderr, "T_IF T_ELSE");}
                    | T_SWITCH T_LBRACKET EXPR T_RBRACKET STATEMENT

ITERATION_STATEMENT : T_WHILE T_LBRACKET EXPR T_RBRACKET STATEMENT {fprintf(stderr, "T_WHILE");}
...
JUMP_STATEMENT : T_GOTO T_IDENTIFIER T_SEMICOLON
               ...
               | T_BREAK T_SEMICOLON
               | T_RETURN EXPR T_SEMICOLON {fprintf(stderr, "T_RETURN");}
               | T_RETURN T_SEMICOLON {fprintf(stderr, "T_RETURN ;");}
...
UNARY_OPERATOR : T_AND {fprintf(stderr, "T_AND");}
               | T_TIMES {fprintf(stderr, "T_TIMES");}
               | T_PLUS {fprintf(stderr, "T_PLUS");}
               | T_MINUS {fprintf(stderr, "T_MINUS");}
               | T_BITWISE_NOT {fprintf(stderr, "T_BITWISE_NOT");}
...
ASSIGNMENT_OPERATOR : T_EQUALS {fprintf(stderr, "T_EQUALS");}
                    | T_TIMES_EQUALS {fprintf(stderr, "T_TIMES_EQUALS");}
                    | T_DIVIDE_EQUALS {fprintf(stderr, "T_DIVIDE_EQUALS");}
                    | T_MODULO_EQUALS {fprintf(stderr, "T_MODULO_EQUALS");}
                    | T_PLUS_EQUALS {fprintf(stderr, "T_PLUS_EQUALS");}
                    | T_MINUS_EQUALS {fprintf(stderr, "T_MINUS_EQUALS");}
                    | T_LEFT_SHIFT_EQUALS {fprintf(stderr, "T_LEFT_SHIFT_EQUALS");}
                    | T_RIGHT_SHIFT_EQUALS {fprintf(stderr, "T_RIGHT_SHIFT_EQUALS");}
                    | T_AND_EQUALS {fprintf(stderr, "T_AND_EQUALS");}
                    | T_XOR_EQUALS {fprintf(stderr, "T_XOR_EQUALS");}
                    | T_OR_EQUALS {fprintf(stderr, "T_OR_EQUALS");}
...
STORAGE_CLASS_SPECIFIER : T_TYPEDEF {fprintf(stderr, "T_TYPEDEF");}
                        | T_EXTERN
                        | T_STATIC
                        | T_AUTO
                        | T_REGISTER

TYPE_SPECIFIER : T_VOID {fprintf(stderr, "T_VOID");}
               | T_CHAR
               | T_SHORT
               | T_INT {fprintf(stderr, "T_INT");}
               | T_LONG
               | T_FLOAT
               | T_DOUBLE
               | T_SIGNED
