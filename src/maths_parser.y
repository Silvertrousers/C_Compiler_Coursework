...
INITIALIZER_LIST : INITIALIZER {$$ = new ast_node("INITIALIZER_LIST","",std::vector<ast_node*>{});}
                 | INITIALIZER_LIST T_COMMA INITIALIZER {$$ = new ast_node("INITIALIZER_LIST","",std::vector<ast_node*>{$1, $2});}
